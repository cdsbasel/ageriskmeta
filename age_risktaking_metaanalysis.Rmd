...
### 8.1. General risk-taking {.tabset}
...
### 8.2. Financial risk-taking {.tabset}
...
### 8.3. Driving risk-taking {.tabset}
...
### 8.4. Recreational risk-taking{.tabset}
...
### 8.5. Occupational risk-taking{.tabset}
#### Linear with gender and age group model
<br>
**Models results:**
<br>
...
<br>
<br>
```{r, echo = F, warning = FALSE, message = FALSE, fig.cap = "Figure: Age trajectories of social risk-taking propensity, moderated by gender and age group."}
b=7
c=1
y_name <- paste0(domains[b],"_z_mean")
  y_number <- paste0(domains[b],"_z_n")
