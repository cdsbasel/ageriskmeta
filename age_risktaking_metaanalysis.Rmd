...
This section offers a detailed overview of the different samples included in the analyses of the paper *Age differences in risk-taking propensity: A coordinated analysis of 10 longitudinal panels*.
...
## 4. Multilevel model process {.tabset}

This section offers a detailed overview of the 7 different models included in the multilevel analysis in the paper *Age differences in risk-taking propensity: A coordinated analysis of 10 longitudinal panels*.
